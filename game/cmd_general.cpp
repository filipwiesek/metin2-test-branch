...
ACMD(do_dice) 
{
    ch->ChatPacket(CHAT_TYPE_INFO, "Nem tudod le�ll�tani.. Nokedli.. "); //You can edit the text :)
}
...
#endif
#ifdef __ITEM_SHOP__
ACMD (do_open_item_shop)
{
	if (ch->GetItemShop() == NULL)
		return;

	ch->GetItemShop().OpenItemShop();
}
